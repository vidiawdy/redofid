      ...
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
               ...
               <div class="iso-section wow fadeInUp" data-wow-delay="2.6s">
                   <center><ul class="text-center" style="height:200px; width:175px">
                       <img src="<?php echo base_url();?>images/redof.jpg" ></ul></center>
                       <center><br>
                           <ul>
                            <h5>For woman in this era, Beauty is a must. Beauty in heart and Beauty in look. Redof.id is a best place for you who want to look more beautiful in look.<br> Bismillah</h5>
                      <br><br>
                        <li>Email : redof@email.com</li>
                        <li>Address : Dukuh Pakis VD No.3 Surabaya</li>
                      </ul>
                      </center>
               </div>
         </div>
