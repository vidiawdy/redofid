         ...
         <div class="col-md-12 col-sm-12">
               ...
               <div class="iso-section wow fadeInUp" data-wow-delay="2.6s">
                  ...
                  <ul class="filter-wrapper clearfix">
                           ...
                           <li><a href="#" class="opc-main-bg" data-filter=".hijab">Hijab</a></li>
                           <li><a href="#" class="opc-main-bg" data-filter=".scarf">Scarff</a></li>
                        ...
                        <div class="iso-box-section wow fadeInUp" data-wow-delay="1s">
                           <div class="iso-box-wrapper col4-iso-box">
                               <?php
                                foreach ($barang as $b){
                                    ?>
                              <div class="iso-box hijab template col-md-4 col-sm-6">
                                 <div class="portfolio-thumb">
                                    <img src="<?php echo base_url($b['path']);?>" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="<?php echo base_url().'single-project.html'?>"><i class="fa fa-link"></i></a>
                                                <h2><?= $b['kode_barang'] ?></h2>
                                             </div>
                                       </div>
                                 </div>
