         ...
         <div class="col-md-12 col-sm-12">
               ...
               <div class="iso-section wow fadeInUp" data-wow-delay="2.6s">
                  ...
                  <div class="filter-wrapper clearfix">
                      ...
                      <a href="<?php echo base_url();?>index.php/welcome/hijab" class="opc-main-bg" >Hijab</a>
                      <a href="<?php echo base_url();?>index.php/welcome/scarf" class="opc-main-bg" >Scarff</a>
             </div>
                                    ...
                                    <img src="<?php echo base_url($b['path']);?>" class="img-responsive" alt="Portfolio">
                                       <div class="portfolio-overlay">
                                          <div class="portfolio-item">
                                                <a href="<?php echo base_url().'index.php/Welcome/contact'?>"><i class="fa fa-link"></i></a>
                                                <h2><?= $b['kode_barang'] ?></h2>
                                                <h2><?= $b['nama_barang'] ?></h2>
                                                <h2>Rp.<?= $b['harga'] ?></h2>
                                             </div>
