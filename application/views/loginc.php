   ...
   <div class="container">
      <div class="row">
         ...
         <div class="col-md-12 col-sm-12">
            ...
            <div class="container">
                <form method="POST" action="<?php echo base_url('index.php/welcome/readc');?>" enctype="multipart/form-data">
                ...
                <a href="<?php echo base_url();?>index.php/welcome/add_Data">Buat akun?</a>
</div>
